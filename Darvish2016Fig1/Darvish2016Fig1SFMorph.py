...
#select SF fraction
flatmask = dataAll['UmV'] > 1.4
slopemask = dataAll['UmV'] > 0.511628 * dataAll['VmJ'] + 0.99
Qmask = (flatmask ==1 ) | (slopemask == 1)
dataAll = dataAll[Qmask]
...
plt.savefig('Darvish2016Fig1SFMorph.pdf')
